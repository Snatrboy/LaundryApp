...
class DioLaundryView extends GetView<DioLaundryController> {
  const DioLaundryView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Dio Library Test'),
